...
public class OrdersDAOImpl implements OrdersDAO {
    ...
    @Override
    public Order create(int customerId, String startingPoint, String destinationPoint, String typeOfCar, int amountOfSeats){
        Order order = new Order();
        order.setCustomerId(customerId);
        order.setStartingPoint(startingPoint);
